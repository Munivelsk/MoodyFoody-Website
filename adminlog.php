                        ...
                        <div class="col-lg-6 text-center text-lg-start">
                            <style>
                                ...
                                #signup-link:hover {
                                    ...
                                    <div id="login-form">
                                        <h2 style="color:white;"><center>Admin Login</center></h2><br>
                                        <form action="admin_panel/index.php" method="post">
                                            <div style="position: relative;">
                                                <input type="text" id="useremail" name="email" placeholder="Admin-Id">
...
if (isset($_POST['email']) && isset($_POST['password'])) {
    ...
    if (substr($_POST['email'], 0, 5) === 'admin') {
        ...
        if ($result->num_rows === 1) {
            ...
            if ($_POST['password'] == $user['password']) {
                ...
                ?>
                <script>
                    window.location.assign("adminlog.php")
                </script>
            <?php
            } else {
        ...
        echo "<p>Only admin emails are allowed to log in.</p>";
    }
}
?>
    ...
    <script src="php/adminnlog.php"></script>
</body>
